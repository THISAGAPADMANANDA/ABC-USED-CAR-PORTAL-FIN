                    ...
                    <form onSubmit={submit}>
                        ...
                        {currentStep === 2 && (
                            <div className="space-y-4">
                                ...
                                <div>
                                    <InputLabel htmlFor="address" value="Address" className="text-gray-700" />
                                    <TextInput
                                        id="address"
                                        name="address"
                                        value={data.address}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <InputLabel htmlFor="city" value="City" className="text-gray-700" />
                                        <TextInput
                                            id="city"
                                            name="city"
                                            value={data.city}
                                    ...
                                    <div>
                                        <InputLabel htmlFor="state" value="State/Province" className="text-gray-700" />
                                        <TextInput
                                            id="state"
                                            name="state"
                                            value={data.state}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <InputLabel htmlFor="postal_code" value="Postal Code" className="text-gray-700" />
                                        <TextInput
                                            id="postal_code"
                                            name="postal_code"
